...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.Adapters.ThistoryAdapter, Mngs Client Support", ThistoryAdapter.class, __md_methods);
	}


	public ThistoryAdapter ()
	{
		super ();
		if (getClass () == ThistoryAdapter.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.Adapters.ThistoryAdapter, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
