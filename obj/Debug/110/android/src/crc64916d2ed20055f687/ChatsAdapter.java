...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.Adapters.ChatsAdapter, Mngs Client Support", ChatsAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ChatsAdapter.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.Adapters.ChatsAdapter, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
