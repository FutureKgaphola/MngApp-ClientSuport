...
public class TechniciansAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.Adapters.TechniciansAdapter, Mngs Client Support", TechniciansAdapter.class, __md_methods);
	}


	public TechniciansAdapter ()
	{
		super ();
		if (getClass () == TechniciansAdapter.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.Adapters.TechniciansAdapter, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
