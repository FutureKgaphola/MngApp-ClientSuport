package crc645835c755d1796ab2;


public class ThistoryEvent
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.EventListeners.ThistoryEvent, Mngs Client Support", ThistoryEvent.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ThistoryEvent.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.EventListeners.ThistoryEvent, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
