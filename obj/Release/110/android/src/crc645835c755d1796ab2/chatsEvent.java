...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.EventListeners.chatsEvent, Mngs Client Support", chatsEvent.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == chatsEvent.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.EventListeners.chatsEvent, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
