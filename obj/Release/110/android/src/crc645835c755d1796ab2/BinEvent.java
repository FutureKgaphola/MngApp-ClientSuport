...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.EventListeners.BinEvent, Mngs Client Support", BinEvent.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == BinEvent.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.EventListeners.BinEvent, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
