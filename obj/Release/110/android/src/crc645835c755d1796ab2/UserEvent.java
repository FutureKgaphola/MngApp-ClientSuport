...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.EventListeners.UserEvent, Mngs Client Support", UserEvent.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == UserEvent.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.EventListeners.UserEvent, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
