...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.Adapters.BinAdapter, Mngs Client Support", BinAdapter.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == BinAdapter.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.Adapters.BinAdapter, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
