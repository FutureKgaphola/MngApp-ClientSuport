...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.Adapters.ChatSecAdapter, Mngs Client Support", ChatSecAdapter.class, __md_methods);
	}


	public ChatSecAdapter ()
	{
		super ();
		if (getClass () == ChatSecAdapter.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.Adapters.ChatSecAdapter, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
