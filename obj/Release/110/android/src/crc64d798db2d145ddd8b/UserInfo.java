...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mngs_Client_Support.UserInfo, Mngs Client Support", UserInfo.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == UserInfo.class)
			mono.android.TypeManager.Activate ("Mngs_Client_Support.UserInfo, Mngs Client Support", "", this, new java.lang.Object[] {  });
	}
