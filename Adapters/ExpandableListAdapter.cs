...
namespace Mngs_Client_Support.Adapters
{
    ...
    {
        private AndroidX.Fragment.App.Fragment _context;
        private List<string> _listDataHeader; // header titles
                                              // child data in format of header title, child title
        private Dictionary<string, List<string>> _listDataChild;

        public ExpandableListAdapter(AndroidX.Fragment.App.Fragment context, List<string> listDataHeader, Dictionary<String, List<string>> listChildData)
        {
            _context = context;
